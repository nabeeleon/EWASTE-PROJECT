...
export default function Resources({ debug = false }: ResourcesProps) {
  ...
  useEffect(() => {
    ...
    return () => console.log('Resources component unmounted')
  }, [])
    ...
    <div className="w-full py-20 relative">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex justify-center mb-12">
          <button
            className="tech-button flex items-center gap-2 text-lg px-8 py-4"
            onClick={handleAudioPlay}
            aria-label="Play sound effect"
          >
            <span role="img" aria-label="Speaker">🔊</span>
            {audioError ? 'Audio Unavailable' : 'Play Recycling Sound'}
          </button>
